...
const Icon = {
  ...
  rotate: (p) => (<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...p}><circle cx="11" cy="12" r="6.3"/><path d="M4.9 12h12.2M11 5.9c1.7 1.7 2.6 3.9 2.6 6.1s-.9 4.4-2.6 6.1c-1.7-1.7-2.6-3.9-2.6-6.1s.9-4.4 2.6-6.1z"/><path d="M19.4 7.6a9.3 9.3 0 011 4.4" strokeDasharray="0.6 3"/><path d="M20.2 9.7l1-2.5-2.6-.5"/></svg>),
