...
try {
  ...
  for (const name of ['map.js','routes.js','route-panel.js','coordinates.json','vendor']) await cp(join(root, 'integrations/ekispell', name), join(temporary, 'site', name), {recursive:true});
