...
const en: KonbiniStrings = {
  ...
  rate: {
    ...
    alreadyRated: 'You already rated this on this device — submitting again sends a new rating for moderation.',
    tapToSubmit: 'Tap a star to submit your rating.',
  },
  newProduct: {
    pageTitle: 'Add a product',
    intro: 'Suggest a convenience-store must-try that isn’t listed yet. The product and your rating both appear after moderation.',
    ...
    fieldBody: 'Your comment',
    fieldCover: 'Photo (attached to your review)',
    optional: 'optional',
    send: 'Submit product',
    sending: 'Submitting…',
...
const zh: KonbiniStrings = {
  ...
  rate: {
    ...
    alreadyRated: '這台裝置已經評價過這個商品了；再次送出會成為新的評分並重新送審。',
    tapToSubmit: '點星星就會直接送出評分。',
  },
  newProduct: {
    pageTitle: '新增商品',
    intro: '分享一個還沒被收錄的超商必吃。商品與你的評分、留言都會經後台審核後公開。',
    ...
    fieldRating: '你的評分',
    fieldBody: '你的心得',
    fieldCover: '照片（會附在你的評論）',
    optional: '選填',
    send: '送出商品',
    sending: '送出中…',
    success: '感謝投稿！商品與評分經審核後就會顯示。',
    errorGeneric: '發生錯誤，請再試一次。',
    errorSignIn: '請先用 Google 登入。',
