  ...
  days: [
    {
      ...
      segments: [
        ...
        { mode: 'tram', label: '江之電（江ノ島電鐵）', from: 'kamakura-sta', to: 'enoshima', durationMin: 24 },
    ...
    },
    {
      ...
      segments: [
        ...
        { mode: 'shinkansen', label: '上越新幹線', from: 'ueno-sta', to: 'tsubame-sanjo-sta', durationMin: 100, viaCoords: [{ lat: 35.9064, lng: 139.6238 }, { lat: 36.3229, lng: 139.0128 }, { lat: 36.9370, lng: 138.8100 }, { lat: 37.4462, lng: 138.8515 }] },
      ],
    ...
    },
    {
      ...
      segments: [
        { mode: 'shinkansen', label: '上越新幹線（清晨返回東京）', from: 'tsubame-sanjo-sta', to: 'ueno-sta', durationMin: 100, viaCoords: [{ lat: 37.4462, lng: 138.8515 }, { lat: 36.9370, lng: 138.8100 }, { lat: 36.3229, lng: 139.0128 }, { lat: 35.9064, lng: 139.6238 }] },
    ...
    },
    {
      ...
      segments: [
        { mode: 'tram', label: '岡山電鐵路面電車（或步行）', from: 'okayama-sta', to: 'okayama-castle', durationMin: 10 },
